-- EEP combined data load import file
-- Resets all databases back to an original state 
-- WARNING: YOU WILL LOSE ANY INPUTTED DATA
-- mysql -u root -p < ~/Desktop/reset_databases.sql
...
DROP DATABASE IF EXISTS leaftech;
